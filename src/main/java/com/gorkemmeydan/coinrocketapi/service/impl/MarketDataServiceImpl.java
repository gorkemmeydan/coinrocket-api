...
public class MarketDataServiceImpl implements MarketDataService {
    ...
    @Override
    public Object[] getCoinsBySearchVal(MarketDataDto marketDataDto) {
        log.info("Getting top coins for the search " + marketDataDto.getSearchVal());

        String url =
                "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=" +
                marketDataDto.getSearchVal() +
